...
public class UserServiceImpl implements UserService {
	...
	public JSONObject addUser(JSONObject jsonObject) {
		...
		String password = MD5Util.encode((jsonObject.getString("password") + salt).getBytes());
		jsonObject.put("password", password);
		int exist = userDao.queryExistUsername(jsonObject);
		if (exist > 0) {
			return CommonUtil.errorJson(ErrorEnum.E_10009);
		}
		userDao.insertUser(jsonObject);
	...
	public JSONObject listPermission(JSONObject jsonObject) {
		...
		List<JSONObject> permissions = userDao.listPermission(jsonObject);
		return CommonUtil.successPage(jsonObject, permissions, count);
	}
	...
	public JSONObject updatePermission(JSONObject jsonObject) {
		userDao.updatePermission(jsonObject);
		return CommonUtil.successJson();
	}
	...
	@Transactional(rollbackFor = Exception.class)
	@Override
	public JSONObject deletePermission(JSONObject jsonObject) {
		userDao.removePermission(jsonObject);
		return CommonUtil.successJson();
	}

	@Override
	public JSONObject selectByUserName(String username) {
